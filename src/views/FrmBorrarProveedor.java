...
public class FrmBorrarProveedor extends BaseFrame {
    ...
    public FrmBorrarProveedor() {
        ...
        proveedoresCombo = (List<Proveedor>) Proveedores.select(Conexion.getDBConexion(), "select * from proveedores", Proveedor.class);
        try {
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
       ingredientesProveedor = (List<Ingrediente>) Ingredientes.select(Conexion.getDBConexion(), String.format("select * from ingredientes where "

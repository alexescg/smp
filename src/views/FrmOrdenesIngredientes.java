...
public class FrmOrdenesIngredientes extends BaseFrame {
    ...
    public FrmOrdenesIngredientes() {
        ...
        proveedoresIngrediente = (List<Proveedor>) Proveedores.select(Conexion.getDBConexion(), "select * from proveedores", Proveedor.class);
    ...
    private void btnPedirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedirActionPerformed
        OrdenesIngedientes.executeQuery(Conexion.getDBConexion(), String.format("insert into ordenes_ingredientes values(%s,%s,%s,%s,%s)", id, ingredientesCombo.get(comboIngrediente.getSelectedIndex()).getId_proveedor(), txtCantidadP.toString(), OrdenIngrediente.CURRENT_TIMESTAMP, txtTotal.getText()));
        this.dispose();

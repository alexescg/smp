...
public class FrmVenderMercancia extends BaseFrame {
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        if(productos.get(comboProductos.getSelectedIndex()).getCantidad_disponible().intValue()>Integer.valueOf(txtCantidad.getText())){
            ...
            Productos.executeQuery(Conexion.getDBConexion(), "update productos set cantidad_disponible ="+productos.get(comboProductos.getSelectedIndex()).getCantidad_disponible().intValue()+" where id_producto="+productos.get(comboProductos.getSelectedIndex()).getId_producto());
            this.dispose();
        }else{
